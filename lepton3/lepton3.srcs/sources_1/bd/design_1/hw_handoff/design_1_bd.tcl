...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ck_ioa [ create_bd_port -dir O -from 0 -to 0 ck_ioa ]
  ...
  set lepton_if_0 [ create_bd_cell -type ip -vlnv adiuvo.com:user:lepton_if:1.0 lepton_if_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {4.000000} \
   ...
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR0 {25} \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {4} \
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins lepton_if_0/reset]
  connect_bd_net -net lepton_if_0_addrb [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins ila_0/probe5] [get_bd_pins lepton_if_0/addrb]
  connect_bd_net -net lepton_if_0_dinb [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins ila_0/probe6] [get_bd_pins lepton_if_0/dinb]
  connect_bd_net -net lepton_if_0_enb [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins ila_0/probe3] [get_bd_pins lepton_if_0/enb]
  connect_bd_net -net lepton_if_0_line_out [get_bd_pins ila_0/probe0] [get_bd_pins lepton_if_0/line_out]
  ...
  connect_bd_net -net lepton_if_0_sclk [get_bd_ports sck] [get_bd_pins ila_0/probe8] [get_bd_pins lepton_if_0/sclk]
  connect_bd_net -net lepton_if_0_ss [get_bd_ports ss] [get_bd_pins ila_0/probe7] [get_bd_pins lepton_if_0/ss]
  connect_bd_net -net lepton_if_0_web [get_bd_pins blk_mem_gen_0/web] [get_bd_pins ila_0/probe4] [get_bd_pins lepton_if_0/web]
  connect_bd_net -net miso_1 [get_bd_ports miso] [get_bd_pins ila_0/probe9] [get_bd_pins lepton_if_0/miso]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins lepton_if_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports ck_ioa] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00020000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
